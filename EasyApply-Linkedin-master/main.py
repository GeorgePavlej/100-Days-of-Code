...
class EasyApplyLinkedin:
    ...
    def job_search(self):
        ...
        search_keywords = self.driver.find_element(By.XPATH, '//*[@id="jobs-search-box-keyword-id-ember235"]')
        search_keywords.clear()
        search_keywords.send_keys(self.keywords)
        search_location = self.driver.find_element(By.XPATH, '//*[@id="jobs-search-box-location-id-ember235"]')
